...
- Configuration est le programme qui permet de modifier le mot de passe du coffre ou de changer la clé, biensûr lui-même protégé par un mot de passe (Passe).
...
- Pour les librairies c'est normal qu'il y est à chaque fois (dans les différents fichiers) les mêmes défintions mais c'est la seule solution à l'erreur
